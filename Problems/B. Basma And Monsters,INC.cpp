...
// Contest: Contest #2
// Judge: Codeforces
// URL: https://codeforces.com/group/0l0qswcrxs/contest/561237/problem/B
// Memory Limit: 256
// Time Limit: 1000
// Start: Fri 25 Oct 2024 04:45:25 PM EEST 
#ifdef RAMEZ
#include "debug.hpp"
#else
#define debug(...) 0
...
void Ramez(){
  int n; cin >> n;
  string winnerName; int winnerScore = -1;
  int sum = 0;
  for (int i = 0; i < n; i++) {
  ...
  cout << "Total scream units: " << sum << endl;
  cout << "Winner Monster: " << winnerName << ", Scream Units: " << winnerScore;
}
