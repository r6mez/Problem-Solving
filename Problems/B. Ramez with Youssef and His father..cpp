...
*/
// Contest: Adventures of Ramez
// Judge: Codeforces
// URL: https://codeforces.com/gym/558481/problem/B
// Memory Limit: 256
// Time Limit: 1000
// Start: Thu 07 Nov 2024 12:58:07 PM EET 
#ifdef RAMEZ
#include "debug.hpp"
#else
#define debug(...) 0
...
void Ramez(){
  ...
  while(q--){
    ...
    for (int i = 0; i < n; i++) {
      if(a[i] > k){
        cout << "Ramez and Youssef are sad " << a[i] << "\n";
        found = true;
        break;
      }
    }   
    if(!found) cout << "Ramez and Youssef are happy\n";
  }
}
