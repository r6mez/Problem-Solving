...
void UseFile() { freopen("prime_subtractorization_validation_input.txt", "r", stdin); freopen("prime_subtractorization_validation_output.txt", "w", stdout); }
