...
// ----------------------------------------------------
// Contest: Codeforces Round 273 (Div. 2)
// Judge: Codeforces
// URL: https://codeforces.com/problemset/problem/478/B
// Memory Limit: 256
// Time Limit: 1000
// Start: Fri 04 Oct 2024 11:24:21 PM EEST 
#ifdef RAMEZ
#include "debug.hpp"
#else
#define debug(...) 0
...
void solve(){
  ll people, teams; cin >> people >> teams;

  ll members = people/teams, kemala3adad = people%teams;

  ll minCount = (teams - kemala3adad) * pairs(members-1) + (kemala3adad) * pairs(members);

  ll bigTeamMemebers = people - teams + 1;
  ll maxCount = pairs(bigTeamMemebers - 1);
