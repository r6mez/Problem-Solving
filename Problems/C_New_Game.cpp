...
// Memory Limit: 512
// Time Limit: 2000
// Start: Mon 14 Oct 2024 06:13:58 PM EEST 
#include <algorithm>
...
/*
NOTES:
each turn take car with value  = a[i] or a[i]+1;
so the most important card is the first one and the ones after

the number of cards with distinct numbers must be <= k
what is the maximum cards we can take?

what card are we interested in?

10 2
2 2 3 3 3 4 4 4 5 5 
cards 2 3 4 5 
freqs 2 3 3 2 
what is the max segement of size 2 that we can take 
ans = 3, 4
