...
// Contest: Contest #4
// Judge: Codeforces
// URL: https://codeforces.com/group/ftB9bVYh2W/contest/564514/problem/B
// Memory Limit: 256
// Time Limit: 1000
// Start: Sun 10 Nov 2024 06:32:34 PM EET 
#include <numeric>
#ifdef RAMEZ
#include "debug.hpp"
#else
...
void Ramez(){
  ...
  for (int i = 0; i < n; i++) {
    ll leftSum = (i? prefixSum[i-1] : 0);
    ll rightSum = prefixSum[n-1] - prefixSum[i];
    if(leftSum == rightSum){
      cout << i << "\n";
      return;
    }
