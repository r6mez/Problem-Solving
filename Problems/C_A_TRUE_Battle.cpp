...
// Memory Limit: 256
// Time Limit: 2000
// Start: Sat 19 Oct 2024 05:23:19 PM EEST 
#ifdef RAMEZ
#include "debug.hpp"
#else
#define debug(...) 0
...
/*
NOTES: 
alice = true (wants to remove 0's places OR between 1 and 0)
bob = false (wants to remove 1's places And between 1 and 0)
alice starts (if)
will alice win?
