...
// ----------------------------------------------------
// problem: Where Am I?
// URL: https://vjudge.net/problem/USACO-964  
// Start: 8/18/2024, 6:54:43 PM
#include <iostream>
#include <algorithm>
#include <cmath>
#include <climits>
...
void UseFile() { freopen("whereami.in", "r", stdin); freopen("whereami.out", "w", stdout); }
