...
void Ramez() {
    ...
    else if (rem == 8 && ((c2 >= 4) || (c2 >= 1 && c3 >= 1))) {
        cout << "YES\n";
    }
    else if (rem == 6 && (c3 >= 1 || c2 >= 3)) {
        cout << "YES\n";
    }
    else if (rem == 4 && c2 >= 2) {
        cout << "YES\n";
    ...
    else if (rem == 3 && (c3 >= 2 || (c3 >= 1 && c2 >= 3) || c2 >= 6)) {
        cout << "YES\n";
    }
    else if (rem == 7 && ((c3 >= 1 && c2 >= 5) || (c3 >= 2 && c2 >= 2) || c2 >= 8)) {
        cout << "YES\n";
    }
    else if (rem == 5 && ((c3 >= 2 && c2 >= 1) || (c3 >= 1 && c2 >= 4) || c2 >= 7)) {
        cout << "YES\n";
    }
    else if (rem == 1 && (c2 >= 5 || (c3 >= 1 && c2 >= 2))) {
        cout << "YES\n";
    }
    else {
        cout << "NO\n";
