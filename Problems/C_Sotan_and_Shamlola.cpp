...
// Contest: Contest #4
// Judge: Codeforces
// URL: https://codeforces.com/group/ftB9bVYh2W/contest/564514/problem/C
// Memory Limit: 256
// Time Limit: 1000
// Start: Sun 10 Nov 2024 08:59:43 PM EET 
#ifdef RAMEZ
#include "debug.hpp"
#else
#define debug(...) 0
...
// number of meals I can make or not
bool can(ll x){
  ll cost = 0;
  cost += max(0ll, x * rb - nb) * pb;
  cost += max(0ll, x * rc - nc) * pc;
  cost += max(0ll, x * rp - np) * pp;
