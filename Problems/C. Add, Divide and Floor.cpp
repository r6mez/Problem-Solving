...
// Memory Limit: 256
// Time Limit: 2000
// Start: Fri 04 Oct 2024 04:16:44 PM EEST 
#ifdef RAMEZ
#include "debug.hpp"
#else
#define debug(...) 0
...
void solve(){
  ...
  cout << ops.size() << "\n"; 
  if(ops.size() <= n) cout << ops << "\n";
}

/*
NOTES:
numbers from small to big 
devide the bigger elements to reach the smaller one
