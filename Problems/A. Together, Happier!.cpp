...
// Contest: Contest #4
// Judge: Codeforces
// URL: https://codeforces.com/group/ftB9bVYh2W/contest/564514/problem/A
// Memory Limit: 256
// Time Limit: 1000
// Start: Sun 10 Nov 2024 08:37:58 PM EET 
#ifdef RAMEZ
#include "debug.hpp"
#else
#define debug(...) 0
...
void Ramez(){
  ...
  while(q--){
    ...
    if(a[n-1] <= k){
      cout << "Ramez and Youssef are happy\n";
      continue;
    }

    if(a[0] > k){
      cout << "Ramez and Youssef are sad " << a[0] << "\n";
      continue;
    }
    ...
    cout << "Ramez and Youssef are sad " << a[r] << "\n";
  }
}
