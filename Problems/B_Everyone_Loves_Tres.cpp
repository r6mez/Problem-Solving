...
// Memory Limit: 256
// Time Limit: 1000
// Start: Sun 27 Oct 2024 05:43:16 PM EEST 
#include <algorithm>
#ifdef RAMEZ
#include "debug.hpp"
#else
...
the number must end in 6 and have a sum of digits that is a multiple of 3.

For divisibility by 11, 
the difference between the sum of digits at odd and even positions should be a multpple of 11.

first digit from right = 6
difference between sum of odd and of even = 0
