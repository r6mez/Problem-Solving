...
// URL: https://vjudge.net/problem/USACO-894  
// Start: 8/24/2024, 3:29:40 PM
#include <iostream>
#include <algorithm>
#include <cmath>
#include <climits>
...
void UseFile() { freopen("planting.in", "r", stdin); freopen("planting.out", "w", stdout); }
...
/*
NOTES:
Color the edges with as less colors as possible
no 3 adjecent edges has the common colors
*/
