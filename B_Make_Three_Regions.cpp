...
int main() {
    ...
    while (t--) {
        int n; cin >> n;
        vector<string> graph(2); cin >> graph;

        int cells = 0;
        for (int i = 0; i < n - 2; i++)
        {
            if (graph[0][i] == 'x' && graph[1][i] == '.' && graph[0][i + 1] == '.' && graph[1][i + 1] == '.' && graph[0][i + 2] == 'x' && graph[1][i + 2] == '.') cells++;
            else if (graph[0][i] == '.' && graph[1][i] == 'x' && graph[0][i + 1] == '.' && graph[1][i + 1] == '.' && graph[0][i + 2] == '.' && graph[1][i + 2] == 'x') cells++;
        }
